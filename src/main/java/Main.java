...
public class Main {
    public static void main(String[] args) throws NoSuchAlgorithmException {
        ...
        Playfair playfair = new Playfair("thekeymustbelong");
        String messageToEncryptPlayfair = "thisisaverybadtext";
        String encryptedMessagePlayfair = playfair.encryptMessage(messageToEncryptPlayfair);
